...
SoundCloudAPI.renderTrack = function( tracks, searchResult ) {
		...
		tracks.forEach(function(track) {
			...
			image_img.src = track.artwork_url || 'https://www.flaticon.com/svg/static/icons/svg/2177/2177093.svg';
...
SoundCloudAPI.getEmbed = function( trackPermalink ) {
	...
	SC.oEmbed(trackPermalink, { auto_play: true }).then(function(oEmbed) {
	  ...
	  // clear
	  //function deleteItems(){ localStorage.clear(); }
	  // clear button
	  //var clearButton = document.createElement('div');
	  //clearButton.classList.add('ui', 'bottom', 'attached', 'button', 'js-button');
	  
	  //var clearbuttonText = document.createElement('span');
